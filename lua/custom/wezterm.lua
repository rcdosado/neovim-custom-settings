...
return {
  ...
  -- font = wezterm.font('Codelia', { weight = 'Bold', stretch = 'Normal', style = 'Normal' }),
  font = wezterm.font('Codelia Ligatures', { weight = 'Bold', stretch = 'Normal', style = 'Normal' }),
  -- font = wezterm.font('Comic Mono', { weight = 'Bold', stretch = 'Normal', style = 'Normal' }),
  -- font = wezterm.font("Comic Mono", {weight="Regular", stretch="Normal", style="Normal"}),
  ...
  -- -- 60.png, 24, 46, 21
  -- window_background_image = os.getenv 'USERPROFILE' .. '/AppData/Local/nvim/rsrc/bg/img46.jpg' or '',
