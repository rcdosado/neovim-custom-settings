...
return {
  ...
  -- font = wezterm.font("IntelOne Mono", {weight="Light", stretch="Normal", style="Normal"}),
  -- font = wezterm.font("IntelOne Mono", {weight="Light", stretch="Normal", style="Italic"}),
  -- font = wezterm.font("IntelOne Mono", {weight="Regular", stretch="Normal", style="Normal"}),
  -- font = wezterm.font("IntelOne Mono", {weight="Regular", stretch="Normal", style="Italic"}),
